...
\$config = array(
    /*
    Use the home key to specify where the application code is located. The path
    specified here must be an absolute path to the application's location.
    */
    'home' => "$home",
        
    /*
    The prefix through which the application is accessed. This tells the 
    framework the automatic prefix to use when dealing with URLs associated with
    this application. Prefixes are mostly dictated by the directories in which
    the application resides relative to the document root of the web server.
    */
    'prefix' => "/$prefix",
        
    /*
    The name of your application. This is normally used for the rendering of
    the HTML title tag.
    */
    'name' => "$name",
    ...
    the value of the \$selected variable within this configuration file.
        
    Below is an example db parameter which has three different database 
    configurations, (main, test and alt_db):
