 ...
 * This document explains into detail the internal operations of the WYF Application 
 * framework. Software engineers or programmers who have to work with the source code of any software built with the WYF Application
 * software must first read and understand this document. It must however be
 * stated that understanding this document is a just a start. The programmer
 * is advised to study the source code to help deepen her understanding.
 * 
 * \section basic_architecture Basic Architecture
 * The WYF Application Framework is Object Oriented and it exhibits some model-view-controller (MVC) characteristics. 
 * The framework provides API's which aid in:
 * -# Database interfacing and abstraction.
 ...
 * -# AJAX operations
 * -# Data and Remote Procedure Call (RPC) Web Services Creation Tools
 * 
 * \section third_party_software Third Party Software
 * The WYF Application framework utilizes other third party libraries to help it work. These software include:
 * - The smarty Template Engine which is used for rendering the templates.
 * - The FPDF PDF generation library which is used for generating the PDF documents.
 * - The Pear Spreadsheet Package which is used for generating the Microsoft Excel documents.
 * - the PHPUnit framework which is used for unit testing the applications built with the framework.
 *
 *******************************************************************************
 *
 * \page general_overview General Overview of the Framework
 * 
 * This chapter aims to give a brief description of the core components of the
 * entire application framework. After reading this chapter the programmer is
 * expected to have a basic understanding of the operations of the entire 
 * framework.
 * 
